...
use MrWebappDeveloper\Webchat\App\Http\Transformers\ChatResource;
...
class NewChat implements ShouldBroadcast
{
     ...
     */
    public function __construct(public ChatItemResource $chat)
    {
        //
    }
    ...
    {
        return Config::get('webchat.new_chat_event');
    }
