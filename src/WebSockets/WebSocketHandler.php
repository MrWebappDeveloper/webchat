...
namespace MrWebappDeveloper\Webchat\WebSockets;
...
class WebSocketHandler implements MessageComponentInterface
{
    ...
    public function onClose(ConnectionInterface $connection)
    {
        ...
        $this->setChatOwnerAsOffline($connection);
    ...
    /**
     * Say to ChatOwnerService that define offline status for chat owner user that has entry socket id
     * @param ConnectionInterface $connection
     * @return void
     */
    private function setChatOwnerAsOffline(ConnectionInterface $connection)
    {
        $res = Http::
        withHeader('accept', 'application/json')
        ->withQueryParameters([
            'socket_id' => $connection->socketId
        ])->post(route('owner.offline.notify'));
